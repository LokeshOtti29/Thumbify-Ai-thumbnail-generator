        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    <Link to='/my-generations' className="hover:text-pink-500 transition">My Generations
                    </Link>
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                <Link to='/generate' onClick={() => setIsOpen(false)} >Generate
                </Link>
                <Link to='/my-generations'onClick={() => setIsOpen(false)} >My Generations
                </Link>
                <Link to='#' onClick={() => setIsOpen(false)}>My Contact
                </Link>
                <Link to='/login' onClick={() => setIsOpen(false)}>Login
                </Link>
