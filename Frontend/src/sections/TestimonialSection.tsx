...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Testimonials" text2="Loved by Creators" text3="We’re constantly improving based on real feedback. If it helped you create better thumbnails faster, we’d love to hear your thoughts." />
